...
public class GenPassword {
    ...
    public byte[] genPasswordToFile(int number_of_Password, int password_length, String path){      
...
//----------------------------------------------------------    
    ...
    public byte[] genPassword(int number_of_Password, int password_length) throws UnsupportedEncodingException{      
        byte[] write = new byte[number_of_Password * (password_length+2)];
        int current_position = 0;
        for(int j = 0; j < number_of_Password; j++){
            byte[] key = randomPassword(password_length);   
            ...
            write[current_position] = '\n';
            current_position++;
            System.out.println(new String(key, "ISO-8859-1"));
        }
